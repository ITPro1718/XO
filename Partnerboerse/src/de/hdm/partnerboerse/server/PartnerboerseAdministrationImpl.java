...
public class PartnerboerseAdministrationImpl extends RemoteServiceServlet implements PartnerboerseAdministration {
	...
	public boolean compare(Suchprofil suchprofill, Profil profil) {
		...
		// eine Auswahl ID im Suchprpfil eingeben oder mehrere? Bei mehreren,
		// würden wir Ablgeichen wenn mindestens 1 Hobby (AuswahlID) mit
		// gesuchtem Profil übereinstimmt.
		// ( If( ArrayList<Int>
		// ProfilAuswahlIDsOfInfoObjekte.contains(SuchProfilAuswahlID) ) return
		// true;
		{
			return true;
		} else

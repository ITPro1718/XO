...
public class Impressum extends VerticalPanel {
	...
	public void onLoad() {
		...
		press.setText(5, 1, "Evelyn Hettman");
		...
		press.setText(11, 0, "Kontakt: ");
		press.setText(11, 1, "ab199@hdm-stuttgart.de ");
		press.setText(12, 1, "0711 123 456");
		
		press.setText(14, 0, "Haftungsausschluss: ");
		press.setText(14, 1, "Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. "
		...
		press.setText(16, 0, "Haftung für Links: ");
		press.setText(16, 1, "Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. "
		...
		press.setText(18, 0, "Urheberrecht: ");
		press.setText(18, 1, "Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. "
